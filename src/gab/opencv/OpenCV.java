...
public class OpenCV {
    	...
    	if(!nativeLoaded){
	    	...
	    	if((PApplet.platform == PConstants.MACOSX && bitsJVM == 64) || (PApplet.platform == PConstants.WINDOWS) || (PApplet.platform == PConstants.LINUX)){
		    	...
		    	System.loadLibrary("opencv_java249"); 	
	    		 ...
	    		 System.err.println("Cannot load local version of opencv_java249  : Linux 32/64, Windows 32 bits or Mac Os 64 bits are only avaible");
	    	}
    	}
    }
	...
	*/
	public void loadCascade(String cascadeFileName){
		...
		String relativePath = "/home/name/projects/processing/opencv-2.4.9/data/haarcascades/" + cascadeFileName;
