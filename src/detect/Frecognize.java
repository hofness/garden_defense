...
public class Frecognize extends PApplet{

	GSCapture video; //video capture
	OpenCV opencv; //video processing
	Arduino atmega; //microcontroller output
	
	int CamSizeX = 320; //set screen size
	int CamSizeY = 240; //set screen size
	...
	public void setup() {
	 ...
	 //atmega = new Arduino(this, "/dev/tty.usbmodem621", 57600);
